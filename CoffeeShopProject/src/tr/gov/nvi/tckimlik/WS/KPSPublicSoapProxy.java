...
public class KPSPublicSoapProxy implements src.tr.gov.nvi.tckimlik.WS.KPSPublicSoap {
  private String _endpoint = null;
  private src.tr.gov.nvi.tckimlik.WS.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new src.tr.gov.nvi.tckimlik.WS.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public src.tr.gov.nvi.tckimlik.WS.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
